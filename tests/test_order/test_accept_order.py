...
# Не смог победить это доп задание. Из-за него не попал в ухдящий мягкий дедлайн...
class TestAcceptOrder:
    ...
    def test_accept_order(self, create_login_and_delete_new_courier, get_order_id_by_track):
